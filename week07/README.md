...
| 項目 | 配分 |
|------|------|
| 簡單迴歸正確（斜率/截距/R²/RMSE/散佈圖） | 15 分 |
| 多元迴歸正確（8 個係數/R²/RMSE） | 15 分 |
| 比較分析有理有據 | 10 分 |
...
| 項目 | 配分 |
|------|------|
| Pipeline 正確（標準化 + 訓練） | 10 分 |
| 係數分析正確 | 10 分 |
| 混淆矩陣 + 判讀（含 FN/FP 情境分析） | 10 分 |
| ROC 曲線 + AUC | 10 分 |
...
| 項目 | 配分 |
|------|------|
| Q1 說明過擬合或雜訊特徵的風險 | 7 分 |
| Q2 正確比較 R² 和 RMSE 的使用場景 | 7 分 |
| Q3 情境分析有深度，FN/FP 判斷合理 | 6 分 |
